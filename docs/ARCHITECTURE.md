...
- The old hand-rolled vanilla-JS dashboard: `central/static/app.js`, `icons.js`,
  ...
  wholesale by the React/Tailwind/shadcn SPA in `web/` (see "Central dashboard" in
  `CLAUDE.md`), not deprecated alongside it. Git history has the old one if you need to
