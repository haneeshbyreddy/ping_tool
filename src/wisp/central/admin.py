...
rest (org users, team, attendance) from the console.
    ...
    PYTHONPATH=src python -m wisp.central.admin create-user --org ispA --username a --password ... --role owner
    PYTHONPATH=src python -m wisp.central.admin set-org   --org ispA --name "ISP A" --topic ispA-ops
